...
float dist_min, dist_max, dist_raw, dist_last, dist_middle; // unit: mm
...
// initialize USS related variables
  dist_min = _DIST_MIN; 
  dist_max = _DIST_MAX;
  dist_middle = (dist_min+dist_max)/2;
  dist_last = 0;
...
// get a distance reading from the USS
  ...
  if(dist_raw == 0 || dist_raw > 300) dist_raw = dist_last;
...
// turn on the LED if the distance is between dist_min and dist_max
  analogWrite(PIN_LED, abs(dist_middle-dist_raw)/100*255);
