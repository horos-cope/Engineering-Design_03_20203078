...
// get a distance reading from the USS
  ...
  dist_ema = (alpha)*dist_raw + dist_ema*(1-alpha);
...
if(dist_ema < 180.0) {
    ...
    myservo.writeMicroseconds((dist_ema-180)/180*duty_gap+_DUTY_MIN);
  }
